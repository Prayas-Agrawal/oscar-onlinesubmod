...
def gen_dataset(datadir, dset_name, feature, seed=42, isnumpy=False, **kwargs):
    ...
    #     return fullset, valset, testset, num_cls
        ...
        return trainset, valset, testset, num_cls, ((0.1307,), (0.3081,))
    ...
    elif dset_name == "fashion-mnist_ours":
        mnist_transform = transforms.Compose([
            torchvision.transforms.ToTensor(),
            # torchvision.transforms.Normalize((0.1307,), (0.3081,))
        ])
        ...
        return trainset, valset, testset, num_cls, ((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))
        ...
        return trainset, valset, testset, num_cls, ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))

    elif dset_name == "tinyimagenet_ours":
        ...
        return trainset, valset, testset, num_cls, ((0.5071, 0.4865, 0.4409), (0.2673, 0.2564, 0.2762))
        ...
        return trainset, valset, testset, num_cls,((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
    
    
    elif dset_name == "svhn_ours":
        svhn_transform = transforms.Compose([
            transforms.RandomCrop(32, padding=4),
            transforms.RandomHorizontalFlip(),
            transforms.ToTensor(),
